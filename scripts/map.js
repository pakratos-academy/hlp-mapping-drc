$(window).on('load', function() {
  ...
  function onEachFeature(feature, layer) {
    ...
    var countryName = '<h3 style="color:##666666;">Check if it works' + feature.properties.active_hlpHub_congo.ADM1_FR + '</h3>';
    var chair = '<p style="line-height:1.6;">' + feature.properties.Sheet1$.PopUp + '</b></p>';
    var info = countryName + chair + '<p>';
  ...
  function changeAttribution() {
    ...
    credit += ' with ';
    $('.leaflet-control-attribution')[0].innerHTML = disclaimer;
  }
